...
def create_constraints(driver, database: str) -> None:
    ...
    statements = [
        ...
        "CREATE CONSTRAINT evidence_document_name IF NOT EXISTS FOR (n:EvidenceDocument) REQUIRE n.name IS UNIQUE",
        "CREATE CONSTRAINT evidence_section_key IF NOT EXISTS FOR (n:EvidenceSection) REQUIRE n.key IS UNIQUE",
